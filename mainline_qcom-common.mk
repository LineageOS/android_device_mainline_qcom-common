...
# Build environment
ifneq ($(wildcard hardware/qcom-caf/common/Android.bp),)
$(call soong_config_set_bool,mainline_qcom_common,path_hardware_qcom_caf_common_is_present,true)
endif
...
# Mountpoint
ifeq ($(SOONG_CONFIG_mainline_qcom_common_path_hardware_qcom_caf_common_is_present),true)
PRODUCT_PACKAGES += \
